...
_exp_name = "shufflenet_v2_x2_0_lbsmth"
...
Classifier = partial(torchvision.models.shufflenet_v2_x2_0,num_classes=11)
...
model.load_state_dict(torch.load(os.path.join(base_dir,"shufflenet_v2_x2_0_best.ckpt")))
