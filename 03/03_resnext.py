...
_exp_name = "resnext101_64x4d_lbsmth"
...
Classifier = partial(torchvision.models.resnext101_64x4d,num_classes=11)
...
model.load_state_dict(torch.load(os.path.join(base_dir,'resnext101_64x4d_best.ckpt')))
